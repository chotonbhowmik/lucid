...
$args = array(
	...
	'menu_title'                => esc_html__( 'Lucid Options', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Lucid Options', 'your-textdomain-here' ),
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'global-settings',
		'desc'             => esc_html__( 'this is global setting option from there you can upload your logo and favicon!', 'your-textdomain-here' ),
		...
		'fields'           => array(
                      ...
                      array(
                      	'title'            => __( 'Upload Logo', 'your-textdomain-here' ),
		                'id'               => 'upload-logo',
                         ...
                         array(
                      	'title'            => __( 'Upload Favicon', 'your-textdomain-here' ),
		                'id'               => 'upload-favicon',
		                 'desc'             => esc_html__( 'Upload your Fav icon', 'your-textdomain-here' ),
		                 'type'            =>'media'
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Social Media', 'your-textdomain-here' ),
		'id'               => 'social-media',
		'desc'             => esc_html__( 'this is global settingSocial Media option from there you can change your social media', 'your-textdomain-here' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
		'fields'           => array(
                      ...
                      array(
                      	'title'            => __( 'facebook', 'your-textdomain-here' ),
		                'id'               => 'facebook-icon',
		                 'desc'             => esc_html__( 'Upload your facebook icon', 'your-textdomain-here' ),
		                 'type'            =>'text'


            ),
                        array(
                      	'title'            => __( 'twitter', 'your-textdomain-here' ),
		                'id'               => 'twitter-icon',
		                 'desc'             => esc_html__( 'Upload your twitter icon', 'your-textdomain-here' ),
		                 'type'            =>'text'


            ),
                           array(
                      	'title'            => __( 'linkedin', 'your-textdomain-here' ),
		                'id'               => 'linkedin-icon',
		                 'desc'             => esc_html__( 'Upload your linkedin icon', 'your-textdomain-here' ),
		                 'type'            =>'text'


            ),
                          array(
                      	'title'            => __( 'youtube', 'your-textdomain-here' ),
		                'id'               => 'youtube-icon',
		                 'desc'             => esc_html__( 'Upload your youtube icon', 'your-textdomain-here' ),
		                 'type'            =>'text'


            ),
                            array(
                      	'title'            => __( 'dribbble', 'your-textdomain-here' ),
		                'id'               => 'dribbble-icon',
		                 'desc'             => esc_html__( 'Upload your dribbble icon', 'your-textdomain-here' ),
		                 'type'            =>'text'
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'footer-settings',
		'desc'             => esc_html__( 'this is footer setting option ', 'your-textdomain-here' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
		'fields'           => array(
                      ...
                      array(
                      	'title'            => __( 'Copyright Content', 'your-textdomain-here' ),
		                'id'               => 'copyright-content',
		                 'desc'             => esc_html__( 'Upload your copyright content', 'your-textdomain-here' ),
		                 'type'            =>'textarea'
